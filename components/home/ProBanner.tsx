  ...
  return (
    <section className="py-10">
      <div className="max-w-[1280px] mx-auto px-4">
        <div className="relative overflow-hidden bg-blue-600 rounded-[20px] px-8 py-10 md:py-12 shadow-lg shadow-blue-500/10">
          {/* Background decoration */}
          <div className="absolute -right-20 -top-20 w-72 h-72 bg-blue-500 rounded-full opacity-30 pointer-events-none" />
          <div className="absolute -right-8 -bottom-16 w-48 h-48 bg-blue-700 rounded-full opacity-40 pointer-events-none" />
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <Link
              href="/pro"
              className="shrink-0 px-6 py-3.5 bg-white text-blue-600 font-bold rounded-[10px] hover:bg-blue-50 transition-colors text-sm shadow-md"
            >
              Khám phá gói PRO →
            </Link>
          </div>
